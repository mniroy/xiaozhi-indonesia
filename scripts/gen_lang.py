...
def generate_header(lang_code, output_path):
    ...
    # Construct language JSON file path
    ...
    # Merge sound file lists: User language overrides base language
    ...
    for file in sorted(all_sound_files):
        ...
        # Prefer current language audio, fallback to en-US if missing
