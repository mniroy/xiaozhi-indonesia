...
Es8389AudioCodec::Es8389AudioCodec(void *i2c_master_handle, i2c_port_t i2c_port,
                                   ...
                                   gpio_num_t pa_pin, uint8_t es8389_addr,
                                   bool use_mclk) {
  duplex_ = true;           // Is duplex
  input_reference_ = false; // Whether to use reference input for AEC
...
void Es8389AudioCodec::CreateDuplexChannels(gpio_num_t mclk, gpio_num_t bclk,
