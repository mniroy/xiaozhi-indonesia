...
private:
  ...
  void InitializeSsd1306Display() {
    ...
    ESP_ERROR_CHECK(
        esp_lcd_new_panel_io_i2c_v2(codec_i2c_bus_, &io_config, &panel_io_));
...
public:
  XminiC3Board() : boot_button_(BOOT_BUTTON_GPIO) {
    ...
    // Avoid using incorrect firmware, put EFUSE operation at the end
    // Use ESP32C3's VDD SPI pin as a normal GPIO
