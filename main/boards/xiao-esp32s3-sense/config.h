...
#define AUDIO_I2S_METHOD_PDM

// PDM Microphone Pins (built-in on Sense expansion board)
...
// Camera Config (OV2640 on Sense expansion board)
...
// External SPI Display Pins (directly accessible via expansion board)
// Note: Connect an external SPI display to these pins
